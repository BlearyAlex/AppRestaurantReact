...
function CategoryEditDialog({ open, onClose, onSubmit, submitting, categoryToEdit }: { open: boolean, onClose: () => void, onSubmit: (values: any) => void, submitting: boolean, categoryToEdit: CategoryResponse | null }) {
