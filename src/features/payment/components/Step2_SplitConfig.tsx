...
import {type SplitType, usePaymentStore} from "@/features/payment/store/paymentStore";
import type {DinerRequest} from "@/features/payment/types/payment";
import { DinerConfigRow } from './DinerConfigRow';
