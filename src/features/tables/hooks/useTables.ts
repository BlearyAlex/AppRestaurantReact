...
import type { TableOrderResponse, UpdateProductQuantityDto } from "@/features/orders/types/order";
import type { CreateTableDto, TableResponse } from "@/features/tables/types/table";
