                        ...
                        return (
                            <SidebarMenuItem key={item.title}>
                                <div className="flex items-center w-full">
                                    ...
                                    >
                                        <Link to={item.url} tabIndex={hasSubmenu ? -1 : 0}
                                            ...
                                            {item.title === 'Ordenes Completadas' && <WaiterBadge/>}
...
function KitchenBadge() {
    ...
    return (
        <div className="relative flex items-center justify-center ml-auto mr-2">
            {/* Radar pulsante */}
            <span className="absolute h-6 w-6 rounded-full bg-red-500 opacity-50 animate-ping"></span>
            {/* Dot central con número */}
            <span
                className="relative inline-flex h-5 w-5 min-w-5 px-1.5 text-[10px] font-bold items-center justify-center rounded-full bg-red-500 text-white shadow-lg shadow-red-500/50">
        {pendingCount}
      </span>
        </div>
    );
...
function WaiterBadge() {
    ...
    const readyCount = orders.filter(order => order.kitchenStatus === 'Ready').length;
