...
function TakeOrder({ tableId: propTableId }: TakeOrderProps) {
    const { data: productsData, fetchProducts } = useProducts();
    const [selectedCategory, setSelectedCategory] = useState("all");
    const [tableId, setTableId] = useState<number | string | null>(propTableId || null);
    ...
    // Transformar los productos seleccionados a la estructura de CreateOrderProductDto
    const productToSubmit = selectedProducts.map((item) => ({
